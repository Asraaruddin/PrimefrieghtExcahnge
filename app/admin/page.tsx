  ...
  const handleAddShipment = async () => {
    try {
      const { error } = await supabase.from('shipments').insert([{
        ...
        scheduled_delivery: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString(),
        estimated_days: 7,
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gray-800 rounded-2xl border border-gray-700 w-full max-w-2xl">
            <div className="px-6 py-4 border-b border-gray-700">
              <div className="flex justify-between items-center">
                <h3 className="text-xl font-bold">Add New Shipment</h3>
                <button
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setNewShipment({...newShipment, status: e.target.value as 'pending'})}
                      className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      type="text"
                      value={newShipment.origin_state}
                      onChange={(e) => setNewShipment({...newShipment, origin_state: e.target.value})}
                      className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={newShipment.destination_state}
                      onChange={(e) => setNewShipment({...newShipment, destination_state: e.target.value})}
                      className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
