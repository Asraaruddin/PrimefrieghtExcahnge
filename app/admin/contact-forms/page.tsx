...
import {
  ...
  Shield, Globe,  Bell, Copy, FileText
} from 'lucide-react';
...
export default function ContactSubmissionsPage() {
  ...
  const calculateStats = () => {
    ...
    setStats({ total, new: newCount, read, replied, archived, spam });
  };
  ...
  const handleBulkStatusUpdate = async (newStatus: ContactSubmission['status']) => {
    if (bulkAction.selectedIds.size === 0) return;
    ...
    try {
      ...
      showNotification(`${bulkAction.selectedIds.size} submissions updated to ${newStatus}`, 'success');
      setBulkAction({ isSelecting: false, selectedIds: new Set() });
      fetchSubmissions();
    } catch (error) {
  ...
  const openDetailsModal = (submission: ContactSubmission) => {
  ...
  const getUniqueSources = () => {
    const sources = submissions.map(s => s.source).filter(Boolean) as string[];
    ...
    <div className="p-6 bg-gray-900/50 min-h-screen">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-purple-500/30 transition-all duration-300 group hover:scale-[1.02]">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-sm text-gray-400 mt-1">Replied</div>
              </div>
          ...
          <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-gray-500/30 transition-all duration-300 group hover:scale-[1.02]">
            <div className="flex items-center justify-between">
              <div>
          ...
          <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-red-500/30 transition-all duration-300 group hover:scale-[1.02]">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-3xl font-bold text-white">{stats.spam}</div>
                <div className="text-sm text-gray-400 mt-1">Spam</div>
              </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="relative group">
                <select
                  onChange={(e) => handleBulkStatusUpdate(e.target.value as ContactSubmission['status'])}
                ...
                <tr key={submission.id} className="hover:bg-gray-700/20 transition-all duration-300 group">
                  ...
                  <td className="px-6 py-4">
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-400">{submission.company || 'No company'}</span>
                      </div>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <a
                        href={`mailto:${submission.email}?subject=Re: Your Contact Form Submission&body=Hi ${submission.name},%0A%0AThank you for reaching out. We received your message regarding:%0A%0A"${submission.message.substring(0, 100)}..."%0A%0A`}
        ...
        {filteredSubmissions.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-500 mb-6 max-w-md mx-auto">
              {searchQuery ? 'Try adjusting your search or filters to find what you\'re looking for.' : 'No contact form submissions have been received yet.'}
            </p>
          </div>
        )}
      </div>
      ...
      {showDetailsModal && selectedSubmission && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl border border-gray-700/50 w-full max-w-2xl overflow-hidden shadow-2xl max-h-[90vh] overflow-y-auto">
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between p-3 bg-gray-700/30 rounded-lg">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-white">{selectedSubmission.phone || 'Not provided'}</span>
                      </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between p-3 bg-gray-700/30 rounded-lg">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-white">{selectedSubmission.company || 'Not provided'}</span>
                      </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  <select
                    ...
                    onChange={(e) => {
                      handleStatusChange(selectedSubmission.id, e.target.value as ContactSubmission['status']);
            ...
            <div className="px-6 py-4 border-t border-gray-700/50 flex flex-col sm:flex-row justify-between gap-4">
              <div className="flex space-x-3">
                <a
                  href={`mailto:${selectedSubmission.email}?subject=Re: Your Contact Form Submission&body=Hi ${selectedSubmission.name},%0A%0AThank you for reaching out. We received your message regarding:%0A%0A"${selectedSubmission.message.substring(0, 100)}..."%0A%0A`}
